    ...
    <Container>
      <KpisBox>
          <KpisContainer>
            ...
            <KpisNumber>8,461 <span>New Booking</span></KpisNumber>
          
          </KpisContainer>
        
          <KpisContainer>
            <AiOutlineCalendar className='icon'/>
            <KpisNumber>963 <span>Scheduled Room</span></KpisNumber>
            
          </KpisContainer>

          <KpisContainer>
            <BsBoxArrowInRight className='icon'/>
            <KpisNumber>516<span>Check In</span></KpisNumber>
            
          </KpisContainer>

          <KpisContainer>
            <BsBoxArrowInLeft className= 'icon'/>
            <KpisNumber>516<span>Check Out</span></KpisNumber> 
          </KpisContainer>  
