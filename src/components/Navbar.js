...
import { SideBar, SideBarNav,Logo,H2,UserContainer, ImgContainer, H3, H4, H5} from '../styled/SideBar';
...
const Navbar = () => {
  ...
  <SideBar sidebar={sidebar}>
      ...
      <Logo>
        ...
        <H2>travl<span>Hotel Admin Dashboard</span></H2>
      </Logo>
        
    <SideBarNav>
          <li>
          <Link to="/" onClick={()=>setPage("Dashboard")}>
          <RiDashboardLine className='icon'/>Dashboard</Link>
          </li>
         
          <li>
          <Link to="/rooms" onClick={()=>setPage("Rooms")}>
          <AiOutlineKey className='icon'/>Rooms </Link>
          </li>
         
          <li>
          <Link to="/bookings" onClick={()=>setPage("Bookings")}> 
          <AiOutlineCalendar className='icon'/>Bookings </Link>
          </li>
         
          <li>
          <Link to="/users" onClick={()=>setPage("Users")}>
          <FiUser className='icon'/>Users</Link>
          </li>
         
          <li>
          <Link to="/contacts" onClick={()=>setPage("Contact")}>
          <BiMessageCheck className='icon'/> Contact </Link>
          </li>
