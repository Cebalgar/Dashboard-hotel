...
const Bookings = (props) => {
  ...
  return (
    <>
      <ContainerMenu>
        <li>
          <ButtonMenu>All Bookings</ButtonMenu>
        </li>
        <li>
          <ButtonMenu>Checking In</ButtonMenu>
        </li>
        <li>
          <ButtonMenu>Cheking Out</ButtonMenu>
        </li>
        <li>
          <ButtonMenu>In Progress</ButtonMenu>
        </li>
      </ContainerMenu>
          ...
          <tbody>
            ...
            {bookings.map((booking) => (
              <Tr key = {booking.id}>
                ...
                <Td>
                  <ButtonStatusBooking status={booking.status}>
                    {booking.status}
                  </ButtonStatusBooking>
                </Td>
              </Tr>
